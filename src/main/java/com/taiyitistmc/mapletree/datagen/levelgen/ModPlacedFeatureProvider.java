...
public class ModPlacedFeatureProvider {
    ...
    public static final ResourceKey<PlacedFeature> RED_MAPLE_TREES_PLACED =
            register("red_maple_trees_placed");
    ...
    public static void placedFeature(BootstrapContext<PlacedFeature> context) {
        ...
        PlacementUtils.register(context, RED_MAPLE_TREES_PLACED, red_maple_tree_holder, VegetationPlacements.treePlacement(PlacementUtils.countExtra(10, 0.1F, 1)));
    }
